...
(() => {
  ...
  const copy = {
    zh: {
      ...
      emptyTitle: "把标定板放入画面", emptyHint: "点击“查看画面”，检查标定板是否被识别。",
      previewAlt: "当前标定板画面与检测角点", previewHint: "检测到的角点会标在图上。画面只在点击后更新。",
      previewButton: "查看画面", currentStep: "现在做什么", stepPreview: "看清标定板", stepSave: "换位置采集", stepSolve: "计算结果",
    ...
    en: {
      ...
      emptyTitle: "Place the board in view", emptyHint: "Select Preview to check that the board is detected.",
      ...
      previewButton: "Preview", currentStep: "What to do now", stepPreview: "Check the board", stepSave: "Vary and capture", stepSolve: "Solve",
